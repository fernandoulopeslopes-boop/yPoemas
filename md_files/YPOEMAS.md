...
>Cada yPoema entregue ao leitor é fruto de uma estrutura preservada e rígida.
>O código original é um porto seguro que ancora a essência da obra.
>
...
>
>A Expansão (✚): Para mergulhar em camadas e variações profundas do yPoema atual.
>
>A Memória (◀/▶): Um trânsito seguro entre os acervos da Machina.
>
>O Acaso (✻): Onde a Machina seleciona, dentro de seu inventário, uma nova direção.
>
>A Revelação (?): o modo de ajuda, que revela a análise estrutural e a arquitetura invisível
>                 que sustenta cada verso produzido.
>
>IV. Os Domínios da Machina
>    A produção da Machina organiza-se em territórios distintos, cada qual com sua personalidade:
>    Acervos Temáticos: Livros como "Livro Vivo" e "Linguafiada" exploram diferentes tons da existência humana.
>
>Modo Demo: Uma galeria de contemplação automática, onde os yPoemas fluem em um ritmo constante e hipnótico.
>
>Eureka: O portal de busca, onde a lógica localiza o yPoema desejado a partir de fragmentos semânticos.
>
>V. Conclusão
