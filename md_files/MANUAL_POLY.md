...
- O idioma selecionado ficará disponível no botão **"⚒️"**  
dos idiomas.  
- É preciso confirmar **"✔"** a seleção.  
- Obviamente as traduções dependem da velocidade da sua  
internet...  
- Recomenda-se a leitura do texto **traduttore** na página  
**sobre**.  
___  
**importante:**  
...
> Para os idiomas abaixo o **Google** traduz os textos para  
o **inglês**:  
>> Dinamarquês(da), Esperanto(eo), Galês(cy), Haitiano(ht),  
Hebreu(iw), Hebreu(he),  
>> Holandês(nl), Indonésio(id), Irlandês(ga), Islandês(is),  
Malaio(ms), Maltês(mt),  
>> Myanmar(my), Norueguês(no), Samoano(sm), Suaíli(sw),  
Sueco(sv) e Ucraniano(uk).  

> Para alguns idiomas, vê-se na tradução caracteres  
estranhos ao texto:  
>> são variações como **<br>**, ** br>**, **<br **.  
>> Esses caracteres são usados como padrão para a  
**quebra-de-linha** nos textos.  

>> - Ainda não encontrei solução para essas possíveis  
**falhas**.  
