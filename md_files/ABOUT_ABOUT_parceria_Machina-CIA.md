...
## 1. Ideia central  parceria_Machina-CIA
...
2. se não pertence: não mexe.
3. se pertence: o risco é aceitável?
4. se o risco for alto demais: não mexe.
5. se houver opções Machina aprovadas: escolhe uma, com chance baixa.
...
2. Surge uma oportunidade de entrosamento Machina.
3. Abre-se TALK.
4. Mostra-se o trecho original.
5. Mostra-se uma ou duas alternativas.
...
```text
uso máximo: 15% a 20%
no máximo 1 palavra Machina por análise curta
no máximo 2 numa análise completa
nunca substituir se a frase perder precisão
```
...
2. ter campo de uso claro;
3. não parecer intrusa;
4. ampliar a leitura;
5. manter risco aceitável;
6. continuar rara.
```
...
um autor humano;
uma Machina poética;
uma IA como parceira de código, organização e crítica;
um processo a quatro mãos sob curadoria humana.
```
...
+ rebeldia coerente
+ curadoria humana
+ regras anárquicas muito bem conceituadas
```
