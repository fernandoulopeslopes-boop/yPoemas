...
mas que na realidade quer dizer que toda a tradução não corresponde exatamente  
...
Esse número está aumentando porque os idiomas de novos países surgem todos os dias.  
...
Em alguns idiomas (para o Google Translate) parece não haver distinção entre "língua" e "idioma".  
___   
