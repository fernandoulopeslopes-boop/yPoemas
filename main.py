...
<style>
    ...
    .stButton button { height: 38px !important; }
</style>
...
# --- 5. PALCO E RÉGUA (SEM SIDE-BUTTONS) ---
with c_palco:
    # Usando a sequência de pesos apenas para os botões principais
    ...
    st.info(f"O palco está limpo. O acesso ao Help (Estrela) foi removido para teste.")
