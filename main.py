...
def main():
    # Setup inicial de página
    try: 
        st.set_page_config(layout="wide", page_title="yPoemas", page_icon="icon_ypo.ico")
    except: 
        pass

    # CSS: Sidebar 300px + Remoção de poluição no topo do Palco
    st.markdown("""
        <style>
            ...
            /* Garante que o selectbox não crie espaço extra no palco */
            [data-testid="stVerticalBlock"] > div:first-child { margin-top: -2rem; }
        </style>
    ...
    # --- 2. PALCO CENTRAL: TAB BAR (MOTOR DE NAVEGAÇÃO) ---
    ...
    # Sincronização imediata para evitar lag na Sidebar e na Arte
    ...
    with st.sidebar:
        # Bloco I: Identidade (Apenas Logo)
        ...
        # Conversão de nome para arquivo: "off-máquina" -> "OFF_MÁQUINA"
    ...
    # A Arte da página (JPG) como abertura do palco
